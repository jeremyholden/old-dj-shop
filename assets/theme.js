...
theme.addToCartflip = function ($addToCartBtn) {
  ...
  $addToCartBtn
    ...
    .removeClass('disabled')
    .find('span')
    .text("translation missing: en.products.product.view_cart")
    .end()
    ...
    .after('<span class="continue-shopping"> <a class="btn--secondary" href="/collections/all">translation missing: en.products.product.continue_shopping</a></span>');
